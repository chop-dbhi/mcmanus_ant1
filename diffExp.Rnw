...
writeGoTables<-function(tissue,category,geneSet,refCols,altCols){
  ...
  write.table(gage_results$greater,file=paste("GO",tissue,"ant1",category,"up.tab.txt",sep="."),sep="\t",quote=FALSE)
  write.table(gage_results$greater,file=paste("GO",tissue,"ant1",category,"down.tab.txt",sep="."),sep="\t",quote=FALSE)
}
...
writeGoTables("muscle","molecular_function",go.mf.mm,refMuscleCols,altMuscleCols)
writeGoTables("muscle","cellular_component",go.cc.mm,refMuscleCols,altMuscleCols)
writeGoTables("muscle","biological_process",go.bp.mm,refMuscleCols,altMuscleCols)

writeGoTables("heart","molecular_function",go.mf.mm,refHeartCols,altHeartCols)
writeGoTables("heart","cellular_component",go.cc.mm,refHeartCols,altHeartCols)
writeGoTables("heart","biological_process",go.bp.mm,refHeartCols,altHeartCols)
@
