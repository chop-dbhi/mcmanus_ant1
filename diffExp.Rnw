...
res<-cbind(results[res$id,"external_gene_name"],res)
names(res)[1]<-"gene"
...
#convenience table for genego
write.table(resSig[order(resSig$pval),"ensid"][1:50],file=paste(tissue,"top50.pval.txt",sep="."),quote=FALSE,row.names=FALSE,col.names="ensembl")
@
...
#convenience table for genego
write.table(resSig[order(-resSig$fc),"ensid"][1:50],file=paste(tissue,"top50.up.txt",sep="."),quote=FALSE,row.names=FALSE,col.names="ensembl")
@
...
#convenience table for genego
write.table(resSig[order(resSig$fc),"ensid"][1:50],file=paste(tissue,"top50.down.txt",sep="."),quote=FALSE,row.names=FALSE,col.names="ensembl")
@
