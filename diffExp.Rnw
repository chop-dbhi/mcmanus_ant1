...
myXtableOne<-xtable(resSig[order(resSig$pval),1:9],type=tex,caption=paste("Significant (P<",myPval,") differential expression in ANT1 msucle after the correction for multiple testing"),display=c('d','s','s','E','E','E','g','g','g','g'))
