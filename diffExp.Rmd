...
Contingency table: Significantly differentially expressed genes after adjustment for multiple comparisons (padj<0.05). Heart is the left - muscle on the top.
...
table(heart=hvsm$heartdir,muscle=hvsm$muscledir)
 ...
 sets<-c("Heart_Up","Heart_Unchanged","Heart_Down","Muscle_Up","Muscle_Unchanged","Muscle_Down")
  sets<-c("Muscle_Down","Heart_Up","Heart_Unchanged","Heart_Down","Muscle_Up","Muscle_Unchanged")
queries <- list(
